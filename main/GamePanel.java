...
/**
* game panel class for the player
*/
public class GamePanel extends JPanel implements Runnable {
    ...
    */
    ...
    /**
    * The gameloop - loops throughout the duration of the game and updates
    * Checks if game has ended
    * Redraws map 60 times per second
    */
    public void run() {
    ...
    */
    ...
    /**
     * in charge of painting a player
     * @param g is a graphics import
     */
    ...
    */
     ...
     * @param message is a message of the player's movement
     */
